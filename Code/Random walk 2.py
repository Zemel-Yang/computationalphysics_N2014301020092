# -*- coding: utf-8 -*-
"""
Created on Fri Jan 06 14:41:08 2017
...
pl.ylabel('x')
pl.text(40,7,'Random step lengths')
pl.xlim(0,100)
pl.subplot(122)
pl.plot(w,d,'b.')
pl.plot(n,o,'red')
...
pl.ylabel('<$x^2$>')
pl.title('Random walk in one dimension')
pl.text(20,29,'<$x^2$>versus time')
pl.text(20,32,'Random step lengths')
pl.savefig('figure 7.3.png',dpi=144)
pl.show()
